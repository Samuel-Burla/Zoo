    ...
    <div class="table">
        ...
        <?php foreach ($habitats as $key => $habitat) { ?>
            ...
            <div class="table_body table_body_habitats <?php if ($key % 2 === 0) {
                ...
                <div>
                    <a href="/admin/pages/habitat.php?habitat_id=<?= $habitat['habitat_id'] ?>" class="table_head_text actionButton">Modifier</a>
                    <a href="/admin/pages/habitat.php?habitat_id=<?= $habitat['habitat_id'] ?>" class="table_head_text actionButton deleteButton">Supprimer</a>
                </div>
            </div>
